...
var _decisionServices = _interopRequireDefault(require("../services/decisionServices"));
...
function () {
  function decisionsController() {
    (0, _classCallCheck2["default"])(this, decisionsController);
  }

  (0, _createClass2["default"])(decisionsController, null, [{
    key: "getOne",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _decisionServices["default"].getOne(id);
              ...
              case 14:
                ...
                util.setError(400, "A problem occured " + _context.t0.message + ' - ' + id);
                return _context.abrupt("return", util.send(res));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _decisionServices["default"].get_defined_decision();
    ...
    key: "get_specific_decisions",
    value: function () {
      var _get_specific_decisions = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _decisionServices["default"].get_defined_decisions();

              case 3:
                decisions = _context3.sent;
      ...
      function get_specific_decisions(_x5, _x6) {
        return _get_specific_decisions.apply(this, arguments);
      }

      return get_specific_decisions;
    }()
  }, {
    key: "adder",
    value: function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 5;
                return _decisionServices["default"].addNew(data);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 6;
                return _decisionServices["default"].updater(id, data);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                id = req.params.id;
                _context6.next = 4;
                return _decisionServices["default"].deleter(id);
  ...
  return decisionsController;
}();

var _default = decisionsController;
