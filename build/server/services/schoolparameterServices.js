...
var schoolParameterServices =
/*#__PURE__*/
function () {
  function schoolParameterServices() {
    (0, _classCallCheck2["default"])(this, schoolParameterServices);
  }

  (0, _createClass2["default"])(schoolParameterServices, null, [{
    key: "addNew",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _models["default"].SchoolParameters.create(newEntry);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _models["default"].SchoolParameters.destroy({
                  where: {
                    id: id
                  }
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _models["default"].SchoolParameters.update(updated_, {
                  where: {
                    id: id
                  }
                });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return _models["default"].SchoolParameters.findAll();
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return _models["default"].SchoolParameters.findOne({
                  where: {
                    id: id
                  }
                });
  ...
  return schoolParameterServices;
}();

var _default = schoolParameterServices;
exports["default"] = _default;
//# sourceMappingURL=schoolparameterServices.js.map