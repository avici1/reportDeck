...
function () {
  function sectionsService() {
    (0, _classCallCheck2["default"])(this, sectionsService);
  }

  (0, _createClass2["default"])(sectionsService, null, [{
    key: "addNew",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _models["default"].sections.create(newEntry);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _models["default"].sections.destroy({
                  where: {
                    schoolId: id
                  }
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _models["default"].sections.update(updated_, {
                  where: {
                    sectionId: id
                  }
                });
