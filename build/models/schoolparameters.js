...
module.exports = function (sequelize, DataTypes) {
  var SchoolParameters = sequelize.define('SchoolParameters', {
  ...
  SchoolParameters.associate = function (models) {// associations can be defined here
  };

  return SchoolParameters;
};
//# sourceMappingURL=schoolparameters.js.map